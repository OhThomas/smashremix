...
scope FGM {
    ...
    add_sound(Boshi/Sounds/boshi_jump, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_jump2, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_edge_attack, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_shield_break, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_stun, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_grab, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_grab_throw, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_taunt, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_generic_attack, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_down_special, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_down_special2, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_teeter, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_death, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_starko, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_damaged, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_generic_attack2, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_generic_attack3, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Boshi/Sounds/boshi_heavy_lift, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
