...
scope MIDI {
    ...
    insert_midi(TOWEROFHEAVEN, OS.TRUE, OS.TRUE, "Luna Ascension EX", toh, 189)
    ...
    insert_midi(MEMENTOS, OS.TRUE, OS.TRUE, "Last Surprise", persona5, 181)
    ...
    insert_midi(MUTE_CITY, OS.TRUE, OS.TRUE, "Mute City (Brawl)", fzero, 218)
    ...
    insert_midi(MELEE_MENU, OS.TRUE, OS.TRUE, "Melee Menu", melee, 201)
    ...
    insert_midi(BOWSERBOSS, OS.TRUE, OS.TRUE, "Koopa's Theme", sm64, 179)
    insert_midi(POKEMON_STADIUM, OS.TRUE, OS.TRUE, "Trainer Battle", pokemonred, 323)
    insert_midi(BOWSERROAD, OS.TRUE, OS.TRUE, "Koopa's Road", sm64, 177)
    ...
    insert_midi(PORKY_MEDLEY, OS.TRUE, OS.TRUE, "Master Porky Medley", mother3, 200)
    ...
    insert_midi(LIVE_AND_LEARN, OS.TRUE, OS.TRUE, "Live and Learn", sonicadventure2, 186)
    ...
    insert_midi(RACEWAYS, OS.TRUE, OS.TRUE, "Raceways", mk64, 255)
    insert_midi(LINKS_AWAKENING_MEDLEY, OS.TRUE, OS.TRUE, "Link's Awakening Medley", awakening, 183)
    ...
    insert_midi(MAIN_MENU2, OS.TRUE, OS.TRUE, "Menu 2 (Melee)", melee, 203)
    ...
    insert_midi(BLASTCORPS_MENU, OS.TRUE, OS.TRUE, "Menu (Blast Corps)", blastcorps, 202)
    ...
    insert_midi(FUGUE, OS.TRUE, OS.TRUE, "Little Fugue", ssbr, 185)
    ...
    insert_midi(SILVERSURFER, OS.TRUE, OS.TRUE, "Level 1 (Silver Surfer)", silversurfer, 182)
    ...
    insert_midi(LIPS_THEME, OS.TRUE, OS.TRUE, "Lip's Theme", paneldepon, 184)
    ...
    insert_midi(OLD_TOWEROFHEAVEN, OS.TRUE, OS.TRUE, "Luna Ascension", toh, 188)
    ...
    insert_midi(MASKEDDEDEDE, OS.TRUE, OS.TRUE, "Masked Dedede's Theme", kirbytripledx, 199)
    insert_midi(OLD_MUTE_CITY, OS.TRUE, OS.TRUE, "Mute City", fzero, 217)
    ...
    insert_midi(MUTE_CITY_NL, OS.TRUE, OS.TRUE, "Mute City (Nintendo Land)", fzero, 219)
    insert_midi(FIGHT_WITH_SEYMOUR, OS.TRUE, OS-TRUE, "Fight with Seymour", ff10, 111)
    insert_midi(PITCH_BLACK_INTRUSION, OS.TRUE, OS.TRUE, "Pitch Black Intrusion", castlevania_dos, 245)
    ...
    insert_midi(BOWSERROOM, OS.TRUE, OS.TRUE, "Koopa's Room", b3313, 178)
    insert_midi(LANCEBATTLE, OS.TRUE, OS.TRUE, "Lance Battle", stadium2, 180)
    ...
    insert_midi(LOST, OS.TRUE, OS.TRUE, "Lost", dream, 187)
    insert_extra_midi(OLD_FALCO_VICTORY)
    insert_midi(DK_JR_STAGE, OS.TRUE, OS.TRUE, "Donkey Kong Jr. Stage", dkarc, 90)
    insert_midi(VERMILION_CITY, OS.TRUE, OS.TRUE, "Vermilion City", pokemonred, 337)
    insert_extra_midi(RAICHU_VICTORY)
    insert_extra_midi(BOSHI_VICTORY)
    insert_midi(FOREST_MAZE_CAVE_REMIX, OS.TRUE, OS.TRUE, "Forest Maze (Cave Mix)", smrpg, 125)
