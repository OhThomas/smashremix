...
scope MIDI {
    ...
    insert_midi(KOKIRI_FOREST, OS.TRUE, OS.TRUE, "Kokiri Forest", ocarina, 177)
    insert_midi(DR_MARIO, OS.TRUE, OS.TRUE, "Fever", drm, 109)
    ...
    insert_midi(FIRST_DESTINATION, OS.TRUE, OS.TRUE, "Final Destination (Melee)", melee, 118)
    ...
    insert_midi(TOWEROFHEAVEN, OS.TRUE, OS.TRUE, "Luna Ascension EX", toh, 190)
    insert_midi(FOD, OS.TRUE, OS.TRUE, "Gourmet Race (Melee)", kirbysuperstar, 150)
    insert_midi(MUDA, OS.TRUE, OS.TRUE, "Muda Kingdom", sml, 213)
    ...
    insert_midi(MUTE_CITY, OS.TRUE, OS.TRUE, "Mute City (Brawl)", fzero, 219)
    insert_midi(BATTLEFIELD, OS.TRUE, OS.TRUE, "Battlefield", brawl, 25)
    insert_midi(MADMONSTER, OS.TRUE, OS.TRUE, "Mad Monster Mansion", banjokazooie, 194)
    ...
    insert_midi(MELEE_MENU, OS.TRUE, OS.TRUE, "Melee Menu", melee, 202)
    ...
    insert_midi(RBY_GYMLEADER, OS.TRUE, OS.TRUE, "Gym Leader Battle", pokemonred, 160)
    ...
    insert_midi(MACHRIDER, OS.TRUE, OS.TRUE, "Mach Rider (Melee)", machrider, 192)
    ...
    insert_midi(PORKY_MEDLEY, OS.TRUE, OS.TRUE, "Master Porky Medley", mother3, 201)
    ...
    insert_midi(TAZMILY, OS.TRUE, OS.TRUE, "Mom's Hometown", mother3, 210)
    insert_midi(FLAT_ZONE, OS.TRUE, OS.TRUE, "Flat Zone", melee, 120)
    insert_midi(FLAT_ZONE_2, OS.TRUE, OS.TRUE, "Flat Zone II", brawl, 121)
    ...
    insert_midi(BANJO_MAIN, OS.TRUE, OS.TRUE, "Main Title (Banjo-Kazooie)", banjokazooie, 197)
    insert_extra_midi(BOWSER_VICTORY)
    insert_midi(MULTIMAN, OS.TRUE, OS.TRUE, "Multi-Man Melee", melee, 214)
    ...
    insert_midi(FD_BRAWL, OS.TRUE, OS.TRUE, "Final Destination (Brawl)", brawl, 117)
    ...
    insert_midi(KING_OF_THE_KOOPAS, OS.TRUE, OS.TRUE, "King of the Koopas", papermario, 175)
    insert_midi(MRPATCH, OS.TRUE, OS.TRUE, "Mr. Patch", banjo2, 212)
    ...
    insert_midi(FIGHT_AGAINST_BOWSER, OS.TRUE, OS.TRUE, "Fight Against Bowser", smrpg, 110)
    ...
    insert_midi(BK_FINALBATTLE, OS.TRUE, OS.TRUE, "Final Battle (Banjo-Kazooie)", banjokazooie, 115)
    ...
    insert_midi(JUNGLEJAPES, OS.TRUE, OS.TRUE, "Jungle Japes (Melee)", dkc, 171)
    insert_midi(FOREST_INTERLUDE, OS.TRUE, OS.TRUE, "Forest Interlude", dkc2, 125)
    ...
    insert_midi(MABE, OS.TRUE, OS.TRUE, "Mabe Village", awakening, 191)
    insert_midi(REST, OS.TRUE, OS.TRUE, "Rest Area", ssbr, 262)
    insert_midi(FE_MEDLEY, OS.TRUE, OS.TRUE, "Fire Emblem Medley", fire_emblem, 119)
    insert_midi(YOSHI_TALE, OS.TRUE, OS.TRUE, "Yoshi's Tale", yoshis_story, 356)
    insert_midi(FLOWER_GARDEN, OS.TRUE, OS.TRUE, "Flower Garden", yoshis_island, 122)
    ...
    insert_midi(METAL_BATTLE, OS.TRUE, OS.TRUE, "Metal Battle", melee, 206)
    insert_midi(SLIDER, OS.TRUE, OS.TRUE, "Slider", sm64, 281)
    insert_midi(MULTIMAN2, OS.TRUE, OS.TRUE, "Multi-Man Melee 2", melee, 215)
    insert_midi(FIRE_EMBLEM, OS.TRUE, OS.TRUE, "Together We Ride (Melee)", fire_emblem, 322)
    insert_midi(KANTO_WILD_BATTLE, OS.TRUE, OS.TRUE, "Kanto Wild Pokemon Battle", pokemongold, 173)
    ...
    insert_midi(FLYINGBATTERY, OS.TRUE, OS.TRUE, "Flying Battery", sonic3, 123)
    ...
    insert_midi(MONKEY_WATCH, OS.TRUE, OS.TRUE, "Monkey Watch", rhfever, 211)
    ...
    insert_midi(METALLIC_MADNESS, OS.TRUE, OS.TRUE, "Metallic Madness", soniccd, 207)
    ...
    insert_midi(RACEWAYS, OS.TRUE, OS.TRUE, "Raceways", mk64, 256)
    ...
    insert_midi(KIRBY_64_BOSS, OS.TRUE, OS.TRUE, "Kirby 64 Boss", kirby64, 176)
    insert_midi(WALUIGI_PINBALL, OS.TRUE, OS.TRUE, "Waluigi Pinball", mkds, 343)
    ...
    insert_midi(DEDEDE, OS.TRUE, OS.TRUE, "King Dedede's Theme", kirbydreamland, 174)
    insert_midi(DRACULAS_CASTLE, OS.TRUE, OS.TRUE, "Dracula's Castle", castlevania_sotn, 95)
    insert_midi(IRON_BLUE_INTENTION, OS.TRUE, OS.TRUE, "Iron-Blue Intention", castlevania_bloodlines, 169)
    ...
    insert_midi(MK_REVENGE, OS.TRUE, OS.TRUE, "Meta Knight's Revenge", kirbysuperstar, 205)
    insert_midi(SOCCER_MENU, OS.TRUE, OS.TRUE, "Main Menu (ISS64)", isoccer, 195)
    insert_midi(TROUBLE_MAKER, OS.TRUE, OS.TRUE, "Trouble Maker", mischiefmakers, 327)
    insert_midi(MAIN_MENU2, OS.TRUE, OS.TRUE, "Menu 2 (Melee)", melee, 204)
    ...
    insert_midi(BIS_THEGRANDFINALE, OS.TRUE, OS.TRUE, "In The Final", marioluigi_bis, 167)
    insert_extra_midi(GOEMON_VICTORY)
    insert_midi(MAJORA_MIDBOSS, OS.TRUE, OS.TRUE, "Middle Boss Battle", majora, 209)
    insert_midi(WATCH_THEME, OS.TRUE, OS.TRUE, "Q Watch (Pause Menu)", goldeneye, 254)
    insert_midi(KAI_HIGHWAY, OS.TRUE, OS.TRUE, "Kai Highway", mysticalninja, 172)
    ...
    insert_midi(MARINE_FORTRESS, OS.TRUE, OS.TRUE, "Marine Fortress", waverace, 199)
    ...
    insert_midi(BOB, OS.TRUE, OS.TRUE, "Main Theme (Super Mario 64)", sm64, 196)
    insert_midi(AREA6, OS.TRUE, OS.TRUE, "Area 6", starfox64, 6)
    insert_midi(HILLTOPCHASE, OS.TRUE, OS.TRUE, "Hilltop Chase", kirbysuperstar, 162)
    insert_midi(STATUS, OS.TRUE, OS.TRUE, "Status", mariotennis, 299)
    insert_midi(FF4BOSS, OS.TRUE, OS.TRUE, "Boss Encounter", ff4, 44)
    insert_midi(GRIMREAPERSCAVERN, OS.TRUE, OS.TRUE, "Grim Reaper's Cavern", jackbros, 159)
    ...
    insert_midi(FORTRESS_BOSS, OS.TRUE, OS.TRUE, "Fortress Boss", smw, 126)
    insert_midi(HORROR_LAND, OS.TRUE, OS.TRUE, "Horror Land", marioparty2, 164)
    ...
    insert_midi(BLASTCORPS_MENU, OS.TRUE, OS.TRUE, "Menu (Blast Corps)", blastcorps, 203)
    insert_midi(FRAPPE_SNOWLAND, OS.TRUE, OS.TRUE, "Frappe Snowland", mk64, 129)
    insert_midi(SMRPG_BATTLE, OS.TRUE, OS.TRUE, "Fight Against Monsters", smrpg, 111)
    ...
    insert_midi(BIG_BOO, OS.TRUE, OS.TRUE, "Haunted House", sm64, 161)
    ...
    insert_midi(NIGHTMARE, OS.TRUE, OS.TRUE, "Final Boss (Nightmare's Battle)", kirbyadventure, 116)
    ...
    insert_midi(HOGWILD, OS.TRUE, OS.TRUE, "Hog Wild", crash, 163)
    insert_midi(MARATHON, OS.TRUE, OS.TRUE, "Marathon 2 Title Theme", marathon2, 198)
    insert_midi(FORGONE, OS.TRUE, OS.TRUE, "Foregone Destruction", ut99, 124)
    insert_midi(MORRIGAN, OS.TRUE, OS.TRUE, "Theme of Morrigan", mvc, 317)
    insert_midi(ELADARD, OS.TRUE, OS.TRUE, "Eladard", starfox2, 101)
    insert_midi(MADMAZEMAUL, OS.TRUE, OS.TRUE, "Mad Maze Maul", dk64, 193)
    ...
    insert_midi(MURASAKI, OS.TRUE, OS.TRUE, "Murasaki Forest", mother3, 217)
    ...
    insert_midi(HORROR_MANOR, OS.TRUE, OS.TRUE, "Horror Manor", warioworld, 165)
    ...
    insert_midi(METAL_CAP, OS.TRUE, OS.TRUE, "Metallic Mario", sm64, 208)
    ...
    insert_midi(CASTLEWALL, OS.TRUE, OS.TRUE, "Inside the Castle Walls", sm64, 168)
    insert_midi(I_BELIEVE_IN_YOU, OS.TRUE, OS.TRUE, "I Believe in You", earthboundb, 166)
    ...
    insert_midi(JUNGLEJAPES64, OS.TRUE, OS.TRUE, "Jungle Japes", dk64, 170)
    ...
    insert_midi(FIRE_FIELD, OS.TRUE, OS.TRUE, "Feel Our Pain (Fire Field)", fzero_gx, 108)
    ...
    insert_midi(OLD_TOWEROFHEAVEN, OS.TRUE, OS.TRUE, "Luna Ascension", toh, 189)
    insert_midi(OLD_BEWARE_THE_FORESTS_MUSHROOMS, OS.TRUE, OS.TRUE, "Beware the Forest's Mushrooms (OG)", smrpg, 29)
    insert_midi(OLD_GREEN_HILL_ZONE, OS.TRUE, OS.TRUE, "Green Hill Zone (OG)", sonic1, 157)
    insert_midi(MASKEDDEDEDE, OS.TRUE, OS.TRUE, "Masked Dedede's Theme", kirbytripledx, 200)
    insert_midi(OLD_MUTE_CITY, OS.TRUE, OS.TRUE, "Mute City", fzero, 218)
    insert_midi(FORTUNA, OS.TRUE, OS.TRUE, "Fortuna", starfox0, 127)
    ...
    insert_midi(MULTIPLAYER_BATTLE, OS.TRUE, OS.TRUE, "Multiplayer Battle (Bomberman DS)", bombermands, 216)
    insert_midi(MUTE_CITY_NL, OS.TRUE, OS.TRUE, "Mute City (Nintendo Land)", fzero, 220)
    insert_midi(FIGHT_WITH_SEYMOUR, OS.TRUE, OS-TRUE, "Fight with Seymour", ff10, 112)
    insert_midi(PITCH_BLACK_INTRUSION, OS.TRUE, OS.TRUE, "Pitch Black Intrusion", castlevania_dos, 246)
    ...
    insert_midi(GRIMGREENFOREST, OS.TRUE, OS.TRUE, "Grim Green Forest", b3313, 158)
    ...
    insert_midi(LOST, OS.TRUE, OS.TRUE, "Lost", dream, 188)
