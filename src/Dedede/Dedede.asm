...
//    // Add Action Parameters                // Action Name             // Base Action  // Animation                 // Moveset Data            // Flags
    ...
    scope dedede_inhale_gfx_routine_: {
        ...
        addiu   a2, r0, Character.id.CBDEDEDE
        beq     t6, a2, _dedede_inhale
        lhu     t6, 0x002A(v1)              // original line 1
	...
	scope check_hat_dedede_: {
		...
		beq		at, v0, _end				// return v0 as Character.id.CBDEDEDE if COWBOY DEDEDE
		lb		at, 0x0980(a0)				// at = current hat ID
    ...
    Character.table_patch_start(recovery_logic, Character.id.CBDEDEDE, 0x4)
    dw recovery_logic; OS.patch_end()
}